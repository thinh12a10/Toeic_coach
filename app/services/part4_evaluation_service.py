...
class Part4EvaluationService:
    ...
    def evaluate(self, document_text: str, question_text: str, audio_bytes: bytes):
        prompt = self._build_prompt(document_text, question_text)
        ...
        total_score = (
            ...
            + result["pacing"]["score"] * self.PACING_WEIGHT
        )
        result["total_score"] = round(total_score, 1)
        return result

    def _build_prompt(self, document_text: str, question_text: str) -> str:
        return f"""
You are a professional TOEIC Speaking examiner.

PART:
TOEIC Speaking Part 4 - Respond to Questions Using Information Provided
...
Evaluation Criteria:
1. Factual accuracy derived from the document
2. Clarity of information delivery
3. Professionalism
4. Pronunciation
...
"""
    ...
    def _response_schema(self):
        ...
        return {
            ...
            "required": ["pronunciation", "intonation", "pacing", "overall_feedback", "study_plan"],
        }
